...
test.describe('My React App', () => {
  ...
  // Negative Test: Check if the page does not contain unexpected text
  test('should not contain unexpected text', async ({ page }) => {
    await expect(page.locator('#root')).not.toContainText('unexpected text');
  });
});